...
class Test(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        assert simplifyjs(views['/couchish/author_name-rev']) == "function(doc){if(type=='post'){emit(doc.author._ref,null)}if(type=='book'){emit(doc.writtenby._ref,null)}}"
        ...
        assert simplifyjs(views['/customdesigndoc/author_surname-rev']) == "function(doc){if(type=='dvd'){emit(doc.writtenby._ref,null)}if(type=='book'){emit(doc.coauthored._ref,null)}}"
    ...
    def test_viewby(self):
        ...
        viewdata = get_views(models_definition, views_definition)
        assert simplifyjs(viewdata['views']['/author/by_last_name']) == "function(doc){if(model_type=='author'){emit(doc.last_name,null)}}"
